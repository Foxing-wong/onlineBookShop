        ...
        tr[i].onclick = function (e) {
            ...
            switch (cls) {
                case 'add': //点击了加号
                    ...
                    if (http == null) return;
                    http = getHttp();
                    var url = "http://localhost:57018/home/updateCartNum?sysID=" + sysID + "&newNum=" + countInout.value;
...
function buyCarDelete(bid, second) {
    ...
    layer.confirm('您确定从购物车删除该商品？', {
        ...
        var url = "http://localhost:57018/serviceAPI/buyCarDelete.ashx?sysID=" + bid;
